...
-- Add task_cycle_completed column to profiles
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS task_cycle_completed boolean NOT NULL DEFAULT false;

-- Update complete_task function to set task_cycle_completed when all sets done
...
BEGIN
  ...
  -- Check if this completion finishes all sets
